            ...
            ->children()
                ...
                ->arrayNode('parameters')
                    ...
                    ->children()
                        ...
                        ->booleanNode('large')->defaultFalse()->end()
                        ->booleanNode('memory_limit')->defaultValue(-1)->end()
                        ...
                        ->arrayNode('status')
                            ->children()
                                ...
                                ->scalarNode('type')->defaultValue(0)->end()
                            ->end()
                        ->end()
                        ...
                        ->scalarNode('database_save_delay')->defaultFalse()->end()
